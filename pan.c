...
short src_ln0 [] = {
	  0,  28,  29,  33,  34,  35,  39,  46, 
	 52,  56,  59,  60,  61,  66,  70,  71, 
	  0, };
S_F_MAP src_file0 [] = {
	{ "-", 0, 0 },
	{ "NS2.pml", 1, 15 },
...
{	/* int i; */
	...
	printf("	mtype  keyA:	6\n");
	printf("	mtype  keyB:	5\n");
	printf("	mtype  agentA:	4\n");
	printf("	mtype  agentB:	3\n");
	printf("	mtype  nonceA:	2\n");
	printf("	mtype  nonceB:	1\n");
...
printm(int x, char *s)
{
	...
	switch (x) {
	case 1: Printf("nonceB"); return;
	case 2: Printf("nonceA"); return;
	case 3: Printf("agentB"); return;
	case 4: Printf("agentA"); return;
	case 5: Printf("keyB"); return;
	case 6: Printf("keyA"); return;
	case 7: Printf("msg3"); return;
	case 8: Printf("msg2"); return;
	case 9: Printf("msg1"); return;
	case 10: Printf("err"); return;
	case 11: Printf("ok"); return;
