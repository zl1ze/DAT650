...
#define pthread_equal(a,b)	((a)==(b))
	...
	case 7: // STATE 3 - NS7.pml:145 - [network?msg,_,data.key,data.content1,data.content2,data.content3] (0:0:7 - 1)
		...
		if (!readtrail)
			...
			((P2 *)_this)->msg = 0;
		_m = 4; goto P999; /* 0 */
	case 8: // STATE 4 - NS7.pml:147 - [intercepted.key = data.key] (0:21:3 - 1)
		IfNotBlocked
		reached[2][4] = 1;
		...
		;
		_m = 3; goto P999; /* 3 */
	case 9: // STATE 10 - NS7.pml:154 - [((intercepted.key==keyI))] (0:0:0 - 1)
		IfNotBlocked
		reached[2][10] = 1;
		if (!((((P2 *)_this)->intercepted.key==2)))
			continue;
		_m = 3; goto P999; /* 0 */
	case 10: // STATE 11 - NS7.pml:156 - [((intercepted.content2==nonceA))] (0:0:0 - 1)
		IfNotBlocked
		reached[2][11] = 1;
		if (!((((P2 *)_this)->intercepted.content2==5)))
			continue;
		_m = 3; goto P999; /* 0 */
	case 11: // STATE 12 - NS7.pml:156 - [knows_nonceA = 1] (0:0:1 - 1)
		IfNotBlocked
		reached[2][12] = 1;
		(trpt+1)->bup.oval = ((int)now.knows_nonceA);
		now.knows_nonceA = 1;
		...
		;
		_m = 3; goto P999; /* 0 */
	case 12: // STATE 13 - NS7.pml:157 - [((intercepted.content2==nonceB))] (0:0:0 - 1)
		IfNotBlocked
		reached[2][13] = 1;
		if (!((((P2 *)_this)->intercepted.content2==4)))
			continue;
		_m = 3; goto P999; /* 0 */
	case 13: // STATE 14 - NS7.pml:157 - [knows_nonceB = 1] (0:0:1 - 1)
		IfNotBlocked
		reached[2][14] = 1;
		(trpt+1)->bup.oval = ((int)now.knows_nonceB);
		now.knows_nonceB = 1;
		...
		;
		_m = 3; goto P999; /* 0 */
	case 14: // STATE 23 - NS7.pml:165 - [msg = msg1] (0:0:1 - 1)
		IfNotBlocked
		reached[2][23] = 1;
		...
		;
		_m = 3; goto P999; /* 0 */
	case 15: // STATE 24 - NS7.pml:166 - [msg = msg2] (0:0:1 - 1)
		IfNotBlocked
		reached[2][24] = 1;
		(trpt+1)->bup.oval = ((P2 *)_this)->msg;
		((P2 *)_this)->msg = 11;
		...
		;
		_m = 3; goto P999; /* 0 */
	case 16: // STATE 25 - NS7.pml:167 - [msg = msg3] (0:0:1 - 1)
		IfNotBlocked
		reached[2][25] = 1;
		(trpt+1)->bup.oval = ((P2 *)_this)->msg;
		((P2 *)_this)->msg = 10;
		...
		;
		_m = 3; goto P999; /* 0 */
	case 17: // STATE 28 - NS7.pml:170 - [recpt = agentA] (0:0:1 - 1)
		IfNotBlocked
		reached[2][28] = 1;
		...
		;
		_m = 3; goto P999; /* 0 */
	case 18: // STATE 29 - NS7.pml:171 - [recpt = agentB] (0:0:1 - 1)
		IfNotBlocked
		reached[2][29] = 1;
		(trpt+1)->bup.oval = ((P2 *)_this)->recpt;
		((P2 *)_this)->recpt = 6;
		...
		;
		_m = 3; goto P999; /* 0 */
	case 19: // STATE 32 - NS7.pml:174 - [data.key = intercepted.key] (0:72:3 - 1)
		IfNotBlocked
		reached[2][32] = 1;
		(trpt+1)->bup.ovals = grab_ints(3);
...
#endif
		;
		/* merge: data.content1 = intercepted.content1(72, 33, 72) */
		reached[2][33] = 1;
...
#endif
		;
		/* merge: data.content2 = intercepted.content2(72, 34, 72) */
		reached[2][34] = 1;
		...
		;
		_m = 3; goto P999; /* 3 */
	case 20: // STATE 35 - NS7.pml:179 - [data.content1 = agentA] (0:0:1 - 1)
		IfNotBlocked
		reached[2][35] = 1;
		...
		;
		_m = 3; goto P999; /* 0 */
	case 21: // STATE 36 - NS7.pml:180 - [data.content1 = agentB] (0:0:1 - 1)
		IfNotBlocked
		reached[2][36] = 1;
		(trpt+1)->bup.oval = ((P2 *)_this)->data.content1;
		...
		;
		_m = 3; goto P999; /* 0 */
	case 22: // STATE 37 - NS7.pml:181 - [data.content1 = agentI] (0:0:1 - 1)
		IfNotBlocked
		reached[2][37] = 1;
		(trpt+1)->bup.oval = ((P2 *)_this)->data.content1;
		...
		;
		_m = 3; goto P999; /* 0 */
	case 23: // STATE 38 - NS7.pml:182 - [(knows_nonceA)] (0:0:0 - 1)
		IfNotBlocked
		reached[2][38] = 1;
		if (!(((int)now.knows_nonceA)))
			continue;
		_m = 3; goto P999; /* 0 */
	case 24: // STATE 39 - NS7.pml:182 - [data.content1 = nonceA] (0:0:1 - 1)
		IfNotBlocked
		reached[2][39] = 1;
		(trpt+1)->bup.oval = ((P2 *)_this)->data.content1;
		...
		;
		_m = 3; goto P999; /* 0 */
	case 25: // STATE 40 - NS7.pml:183 - [(knows_nonceB)] (0:0:0 - 1)
		IfNotBlocked
		reached[2][40] = 1;
		if (!(((int)now.knows_nonceB)))
			continue;
		_m = 3; goto P999; /* 0 */
	case 26: // STATE 41 - NS7.pml:183 - [data.content1 = nonceB] (0:0:1 - 1)
		IfNotBlocked
		reached[2][41] = 1;
		(trpt+1)->bup.oval = ((P2 *)_this)->data.content1;
		...
		;
		_m = 3; goto P999; /* 0 */
	case 27: // STATE 44 - NS7.pml:186 - [data.key = keyA] (0:0:1 - 1)
		IfNotBlocked
		reached[2][44] = 1;
		...
		;
		_m = 3; goto P999; /* 0 */
	case 28: // STATE 45 - NS7.pml:187 - [data.key = keyB] (0:0:1 - 1)
		IfNotBlocked
		reached[2][45] = 1;
		(trpt+1)->bup.oval = ((P2 *)_this)->data.key;
		((P2 *)_this)->data.key = 8;
		...
		;
		_m = 3; goto P999; /* 0 */
	case 29: // STATE 46 - NS7.pml:188 - [data.key = keyI] (0:0:1 - 1)
		IfNotBlocked
		reached[2][46] = 1;
		(trpt+1)->bup.oval = ((P2 *)_this)->data.key;
		((P2 *)_this)->data.key = 2;
		...
		;
		_m = 3; goto P999; /* 0 */
	case 30: // STATE 49 - NS7.pml:191 - [((msg==msg3))] (68:0:1 - 1)
		IfNotBlocked
		reached[2][49] = 1;
		if (!((((P2 *)_this)->msg==10)))
			continue;
		/* merge: data.content2 = 0(0, 50, 68) */
		reached[2][50] = 1;
		...
		;
		_m = 3; goto P999; /* 2 */
	case 31: // STATE 52 - NS7.pml:194 - [(knows_nonceA)] (0:0:0 - 1)
		IfNotBlocked
		reached[2][52] = 1;
		if (!(((int)now.knows_nonceA)))
			continue;
		_m = 3; goto P999; /* 0 */
	case 32: // STATE 53 - NS7.pml:194 - [data.content2 = nonceA] (0:0:1 - 1)
		IfNotBlocked
		reached[2][53] = 1;
		(trpt+1)->bup.oval = ((P2 *)_this)->data.content2;
		...
		;
		_m = 3; goto P999; /* 0 */
	case 33: // STATE 54 - NS7.pml:195 - [(knows_nonceB)] (0:0:0 - 1)
		IfNotBlocked
		reached[2][54] = 1;
		if (!(((int)now.knows_nonceB)))
			continue;
		_m = 3; goto P999; /* 0 */
	case 34: // STATE 55 - NS7.pml:195 - [data.content2 = nonceB] (0:0:1 - 1)
		IfNotBlocked
		reached[2][55] = 1;
		(trpt+1)->bup.oval = ((P2 *)_this)->data.content2;
		...
		;
		_m = 3; goto P999; /* 0 */
	case 35: // STATE 57 - NS7.pml:196 - [data.content2 = nonceI] (0:0:1 - 1)
		IfNotBlocked
		reached[2][57] = 1;
		(trpt+1)->bup.oval = ((P2 *)_this)->data.content2;
		...
		;
		_m = 3; goto P999; /* 0 */
	case 36: // STATE 62 - NS7.pml:200 - [(knows_nonceB)] (0:0:0 - 1)
		IfNotBlocked
		reached[2][62] = 1;
		if (!(((int)now.knows_nonceB)))
			continue;
		_m = 3; goto P999; /* 0 */
	case 37: // STATE 63 - NS7.pml:200 - [data.content3 = nonceB] (0:0:1 - 1)
		IfNotBlocked
		reached[2][63] = 1;
		...
		;
		_m = 3; goto P999; /* 0 */
	case 38: // STATE 64 - NS7.pml:201 - [(knows_nonceA)] (0:0:0 - 1)
		IfNotBlocked
		reached[2][64] = 1;
		if (!(((int)now.knows_nonceA)))
			continue;
		_m = 3; goto P999; /* 0 */
	case 39: // STATE 65 - NS7.pml:201 - [data.content3 = nonceA] (0:0:1 - 1)
		IfNotBlocked
		reached[2][65] = 1;
		(trpt+1)->bup.oval = ((P2 *)_this)->data.content3;
		...
		;
		_m = 3; goto P999; /* 0 */
	case 40: // STATE 67 - NS7.pml:202 - [data.content3 = nonceI] (0:0:1 - 1)
		IfNotBlocked
		reached[2][67] = 1;
		(trpt+1)->bup.oval = ((P2 *)_this)->data.content3;
		...
		;
		_m = 3; goto P999; /* 0 */
	case 41: // STATE 72 - NS7.pml:205 - [network!msg,recpt,data.key,data.content1,data.content2,data.content3] (0:0:0 - 6)
		IfNotBlocked
		reached[2][72] = 1;
		...
		{ boq = now.network; };
		_m = 2; goto P999; /* 0 */
	case 42: // STATE 76 - NS7.pml:207 - [-end-] (0:0:0 - 1)
		IfNotBlocked
		reached[2][76] = 1;
		if (!delproc(1, II)) continue;
		_m = 3; goto P999; /* 0 */
		 ...
		 /* PROC Bob */
	case 43: // STATE 1 - NS7.pml:107 - [partnerB = agentA] (0:0:1 - 1)
		IfNotBlocked
		reached[1][1] = 1;
		...
		;
		_m = 3; goto P999; /* 0 */
	case 44: // STATE 2 - NS7.pml:108 - [pkey = keyA] (0:0:1 - 1)
		IfNotBlocked
		reached[1][2] = 1;
		...
		;
		_m = 3; goto P999; /* 0 */
	case 45: // STATE 3 - NS7.pml:113 - [network?msg1,agentB,data.key,data.content1,data.content2,data.content3] (0:0:4 - 1)
		reached[1][3] = 1;
		if (boq != now.network) continue;
		if (q_len(now.network) == 0) continue;
		...
		_m = 4; goto P999; /* 0 */
	case 46: // STATE 4 - NS7.pml:122 - [pnonce = data.content2] (0:9:5 - 1)
		IfNotBlocked
		reached[1][4] = 1;
		...
		;
		_m = 3; goto P999; /* 4 */
	case 47: // STATE 9 - NS7.pml:128 - [network!msg2,partnerB,messageAB.key,messageAB.content1,messageAB.content2,messageAB.content3] (0:0:0 - 1)
		IfNotBlocked
		reached[1][9] = 1;
		if (q_len(now.network))
			continue;
		...
		{ boq = now.network; };
		_m = 2; goto P999; /* 0 */
	case 48: // STATE 10 - NS7.pml:131 - [network?msg3,agentB,messageAB.key,messageAB.content1,messageAB.content2,messageAB.content3] (0:0:4 - 1)
		reached[1][10] = 1;
		if (boq != now.network) continue;
		if (q_len(now.network) == 0) continue;
		...
		_m = 4; goto P999; /* 0 */
	case 49: // STATE 11 - NS7.pml:135 - [statusB = ok] (0:0:1 - 1)
		IfNotBlocked
		reached[1][11] = 1;
		...
		;
		_m = 3; goto P999; /* 0 */
	case 50: // STATE 12 - NS7.pml:136 - [-end-] (0:0:0 - 1)
		IfNotBlocked
		reached[1][12] = 1;
		if (!delproc(1, II)) continue;
		_m = 3; goto P999; /* 0 */
		 ...
		 /* PROC Alice */
	case 51: // STATE 1 - NS7.pml:28 - [partnerA = agentB] (0:0:1 - 1)
		IfNotBlocked
		reached[0][1] = 1;
		...
		;
		_m = 3; goto P999; /* 0 */
	case 52: // STATE 2 - NS7.pml:28 - [pkey = keyB] (0:10:4 - 1)
		IfNotBlocked
		reached[0][2] = 1;
		(trpt+1)->bup.ovals = grab_ints(4);
		...
		;
		_m = 3; goto P999; /* 4 */
	case 53: // STATE 3 - NS7.pml:29 - [partnerA = agentI] (0:0:1 - 1)
		IfNotBlocked
		reached[0][3] = 1;
		(trpt+1)->bup.oval = now.partnerA;
		now.partnerA = 3;
		...
		;
		_m = 3; goto P999; /* 0 */
	case 54: // STATE 4 - NS7.pml:29 - [pkey = keyI] (0:10:4 - 1)
		IfNotBlocked
		reached[0][4] = 1;
		(trpt+1)->bup.ovals = grab_ints(4);
		(trpt+1)->bup.ovals[0] = ((P0 *)_this)->pkey;
		...
		;
		_m = 3; goto P999; /* 4 */
	case 55: // STATE 7 - NS7.pml:56 - [messageAB.key = pkey] (0:10:3 - 3)
		IfNotBlocked
		reached[0][7] = 1;
		(trpt+1)->bup.ovals = grab_ints(3);
		...
		;
		_m = 3; goto P999; /* 2 */
	case 56: // STATE 10 - NS7.pml:62 - [network!msg1,partnerA,messageAB.key,messageAB.content1,messageAB.content2,messageAB.content3] (0:0:0 - 1)
		IfNotBlocked
		reached[0][10] = 1;
		if (q_len(now.network))
			continue;
		...
		{ boq = now.network; };
		_m = 2; goto P999; /* 0 */
	case 57: // STATE 11 - NS7.pml:69 - [network?msg2,agentA,data.key,data.content1,data.content2,data.content3] (0:0:4 - 1)
		reached[0][11] = 1;
		if (boq != now.network) continue;
		if (q_len(now.network) == 0) continue;
		...
		_m = 4; goto P999; /* 0 */
	case 58: // STATE 12 - NS7.pml:75 - [((((data.key==keyA)&&(data.content1==partnerA))&&(data.content2==nonceA)))] (0:0:0 - 1)
		IfNotBlocked
		reached[0][12] = 1;
		if (!((((((P0 *)_this)->data.key==9)&&(((P0 *)_this)->data.content1==now.partnerA))&&(((P0 *)_this)->data.content2==5))))
			continue;
		_m = 3; goto P999; /* 0 */
	case 59: // STATE 13 - NS7.pml:79 - [pnonce = data.content2] (0:17:4 - 1)
		IfNotBlocked
		reached[0][13] = 1;
		(trpt+1)->bup.ovals = grab_ints(4);
		...
		;
		_m = 3; goto P999; /* 3 */
	case 60: // STATE 17 - NS7.pml:89 - [network!msg3,partnerA,messageAB.key,messageAB.content1,messageAB.content2,messageAB.content3] (0:0:0 - 1)
		IfNotBlocked
		reached[0][17] = 1;
		if (q_len(now.network))
			continue;
		...
		{ boq = now.network; };
		_m = 2; goto P999; /* 0 */
	case 61: // STATE 18 - NS7.pml:93 - [statusA = ok] (0:0:1 - 1)
		IfNotBlocked
		reached[0][18] = 1;
		...
		;
		_m = 3; goto P999; /* 0 */
	case 62: // STATE 19 - NS7.pml:94 - [-end-] (0:0:0 - 1)
		IfNotBlocked
		reached[0][19] = 1;
		if (!delproc(1, II)) continue;
		_m = 3; goto P999; /* 0 */
